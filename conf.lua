...
function love.conf(t)
    ...
    t.window.title = "Slay"         -- The window title (string)
    t.window.icon = nil                 -- Filepath to an image to use as the window's icon (string)
    t.window.width = 1334                -- The window width (number)
    t.window.height = 750               -- The window height (number)
    t.window.borderless = false         -- Remove all border visuals from the window (boolean)
    t.window.resizable = false          -- Let the window be user-resizable (boolean)
    t.window.minwidth = 1334               -- Minimum window width if the window is resizable (number)
